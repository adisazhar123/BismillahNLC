			...
			<div class="lowin-box lowin-login">
				<div class="lowin-box-inner">
					<form method="POST" action="{{ route('login') }}">
						{{ csrf_field() }}
						<p>Selamat datang di NLC Online 2018</p>
						<div class="lowin-group">
							<input id="email" type="email" class="lowin-input {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus placeholder="email address">
							@if ($errors->has('email'))
							...
							<div class="lowin-group password-group">
								<input id="password" type="password" class="lowin-input {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="password">
